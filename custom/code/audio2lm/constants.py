...
def create_dir(path):
    ...
    '''
    cwd = os.getcwd()
    assert os.path.basename(cwd) == 'custom'
...
EMOTION_NET_DATASET_DIR = create_dir(f'data/mfcc/{ACTOR}')
...
LM_ENCODER_DATASET_LANDMARK_DIR = create_dir(f'data/landmark/landmark_68/{ACTOR}/generated_landmarks/') ## NOTE: generated from facial_landmark.py
...
LANDMARK_BASICS = create_dir(f'data/landmark/landmark_68/{ACTOR}/basics/')
